...
public class Perfil_entrevista extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_perfil_entrevista);
        ...
        btnver.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Perfil_entrevista.this, reproducir_entrevista.class);
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (document.exists()) {
                                ...
                                Toast.makeText(Perfil_entrevista.this, "Periodista no encontrado", Toast.LENGTH_SHORT).show();
                            }
                        } else {
                            Log.e("Perfil_entrevista", "Error al obtener la descripción del periodista", task.getException());
                            Toast.makeText(Perfil_entrevista.this, "Error al obtener la descripción del periodista", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (task.getResult().isEmpty()) {
                                Toast.makeText(Perfil_entrevista.this, "No se encontró ningún periodista con esa descripción", Toast.LENGTH_SHORT).show();
                            }
                        } else {
                            Log.e("Perfil_entrevista", "Error al buscar el ID del periodista por descripción", task.getException());
                            Toast.makeText(Perfil_entrevista.this, "Error al buscar el ID del periodista por descripción", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
        ...
        storageReference.getDownloadUrl()
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception exception) {
                        ...
                        Toast.makeText(Perfil_entrevista.this, "Error al cargar la imagen", Toast.LENGTH_SHORT).show();
                    }
                });
    }
    ...
    private void cargarImagenConGlide(Uri uri) {
        // Utilizar la biblioteca Glide para cargar la imagen en el ImageView
        Glide.with(Perfil_entrevista.this)
                .load(uri)
                .into(imageView2);
    }
        ...
        db.collection("info").document(periodistaId)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Toast.makeText(Perfil_entrevista.this, "Periodista eliminado con éxito en Firestore", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(Perfil_entrevista.this, lista_de_entrevista.class);
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(Perfil_entrevista.this, "Error al eliminar el periodista en Firestore", Toast.LENGTH_SHORT).show();
                    }
                });
    }
        ...
        archivoReference.delete()
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Toast.makeText(Perfil_entrevista.this, "Archivo eliminado con éxito en Storage", Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(Perfil_entrevista.this, "Error al eliminar el archivo en Storage", Toast.LENGTH_SHORT).show();
                    }
                });
    }
    ...
    public void modificarInfo() {
        ...
        if (idPeriodista != null && !idPeriodista.isEmpty()) {
           ...
           // nuevosDatos.put("Fecha", fecha.getText().toString());
            ...
            db.collection("info")
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            ...
                            Toast.makeText(Perfil_entrevista.this, "Error al actualizar los datos", Toast.LENGTH_SHORT).show();
                        }
                    });
        } else {
            ...
            Toast.makeText(Perfil_entrevista.this, "No se ha encontrado un ID de periodista", Toast.LENGTH_SHORT).show();
        }
    }
