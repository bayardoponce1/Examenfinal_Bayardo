...
public class subir_entrevista extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_subir_entrevista);
    ...
    private void uploadFileToStorage(StorageReference fileReference, Uri fileUri) {
        ...
        fileReference.putFile(fileUri)
                .addOnSuccessListener(taskSnapshot -> {
                    ...
                    Intent intent = new Intent(subir_entrevista.this, lista_de_entrevista.class);
